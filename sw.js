const CACHE_NAME = 'daily-deutsch-v1.2.36';
const ASSETS = [
  './',
  './index.html',
  './css/style.css?v=1.2.36',
  './js/analytics.js?v=1.2.36',
  './js/motion.js?v=1.2.36',
  './js/auth.js?v=1.2.36',
  './js/db.js?v=1.2.36',
  './js/categories.js?v=1.2.36',
  './js/wordbank.js?v=1.2.36',
  './js/cefr.js?v=1.2.36',
  './js/translator.js?v=1.2.36',
  './js/exercises.js?v=1.2.36',
  './js/leaderboard.js?v=1.2.36',
  './js/insights.js?v=1.2.36',
  './js/profile.js?v=1.2.36',
  './js/language.js?v=1.2.36',
  './js/gemini.js?v=1.2.36',
  './js/ui.js?v=1.2.36',
  './js/app.js?v=1.2.36',
  './icon.png?v=1.2.36',
  './icon-192.png',
