const CACHE_NAME = 'daily-deutsch-v1.0.4';
const ASSETS = [
  './',
  './index.html',
  ...
  './js/auth.js?v=1.0.4',
  './js/db.js?v=1.0.4',
  './js/categories.js?v=1.0.4',
  './js/wordbank.js?v=1.0.4',
  './js/cefr.js?v=1.0.4',
  './js/translator.js?v=1.0.4',
  './js/exercises.js?v=1.0.4',
  './js/insights.js?v=1.0.4',
  './js/app.js?v=1.0.4',
  './icon.png',
  './manifest.json'
];
